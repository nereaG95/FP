...
typedef tUsuario *tPuntUsu;
/*
Es una funcion de tipo booleana que devielve true si se a cargado correctamente el usuario y false cuando el id del es igual al centinela que se?ala el fion del archivo
...
/*
Es un procedimiento que inicializa un usuario con el id y la contrase?a entrados por parametro, e inializa los contedores de las listas de registros a 0
...
*/
void inicializar(tUsuario& usuario, const string id, const string contrasenia);
/*
Es una funcion booleana que dado un usuario y una contrase?a los compara para ver si son iguales, devuelve true si los son y false en caso contrario
E: contrasenia(string): es la contrase?a que queremos validar	
   usuario(tUsuario): es el usuario cuya contrase?a queremos validar
*/
