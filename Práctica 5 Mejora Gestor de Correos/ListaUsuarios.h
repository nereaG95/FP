...
typedef tPuntUsu tArrayUsuaruo[MAX_USUARIO];
...
si se a?adio y false en caso contrario
E: usuario(tUsuario) es el usuario que queremos a?adir
...
/*
Es una funcion que destruye del monton el array de datos dinamico, tambien el array dinamico de los registros y pone le contador a 0
E/S: usuarios(tListaUsuarios) es la lista que se quiere destruir del monton
*/
