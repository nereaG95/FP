...
void mostrarCorreos(const tListaCorreos &correos);
 /*
 Es un procedimiento que destruye el array dinamico liberando la memoria del monton y pone el contador a 0
 E/S: correos(tListaCorreos) es la lista de correos que se quiere borrar
 */
